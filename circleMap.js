...
//CREATE A LIST OF THE COUNTRIES AND THE AMMOUNT OF PEOPLE FROM THAT COUNTRY
var countryList = { }
...
//GEOCODE THE COUNTRY TO LAT AND LNG
...
function codeAddress(countryOnly, callback) {
  for(var i = 0; i < countryOnly.length; i++) {
    currCountry = countryOnly[i];
    var geocoder = new google.maps.Geocoder();
      geocoder.geocode({'address': countryOnly[i]}, function (results, status) {
...
codeAddress(countryOnly, function() {
});
